"""
Django settings for grozevents project.
...
SECRET_KEY = 'django-insecure-h2(1n@qpb+1z*1s@qpo)k(&065rq-hx+h#(c_ji48^mleb&^ao'
...
WSGI_APPLICATION = 'grozevents.wsgi.application'
